<?php 
        ...
        $sql = "SELECT idReserva,nombre,apellidos,telefono,fecha,hora,estado,num_mesa 
        ...
        <table>
            ...
            <?php while ($row = mysqli_fetch_array($query)): ?>
                    <tr>
                        ...
                        <th><a href="actualizarReserva.php?idReserva=<?=$row['idReserva']?>" class="btn-modificar">Modificar</a></th>
                        <th><a href="eliminarReserva.php?idReserva=<?=$row['idReserva'] ?>" class="btn-eliminar">Eliminar</a></th>
                    </tr>
                <?php endwhile; ?>    
            </tbody>
        </table>
